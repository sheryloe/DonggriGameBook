...
- subject: 레일 인도자
- ratio: 4:5
- art_key_runtime: ch11_iron_detour_frost_boss
...
## English Prompt
```text
레일 인도자, Korean disaster setting infected, fused with 잔향 기지 외곽, 분기 레일을 따라 방향을 비트는 저온 개체, radio mast, cold storage, sea fog, archival realism, delayed guilt, industrial body horror, realistic anatomy distortion, cinematic threat portrait, grounded horror
```
